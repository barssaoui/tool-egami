# 2017.03.31 15:13:35 CET
#Embedded file name: /usr/lib/enigma2/python/Components/Renderer/ScrollLabel.py
from skin import applyAllAttributes, parsePosition, parseSize
from Components.VariableText import VariableText
from Components.config import configfile
from Renderer import Renderer
from enigma import eLabel, eSlider, eWidget, ePoint, eSize, gFont, fontRenderClass, eTimer
...
class ScrollLabel(VariableText, Renderer):
    ...
    def spreadSingleAttribute(self, skinAttributes):
        for attrib, value in skinAttributes:
            ...
            elif attrib in ('borderColor', 'borderWidth', 'sliderBackground', 'sliderForeground', 'sliderPointer'):
                self.scrollbar_attribs.append((attrib, value))
            elif attrib in ('font', 'transparent', 'foregroundColor', 'backgroundColor', 'halign'):
                self.longtext_attribs.append((attrib, value))
            elif attrib == 'css':
