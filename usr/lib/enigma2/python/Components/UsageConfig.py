...
def InitUsageConfig():
    ...
    config.usage.service_icon_custom_picon = ConfigYesNo(default=False)
    config.usage.multiepg_ask_bouquet = ConfigYesNo(default=False)
    config.usage.showpicon = ConfigYesNo(default=True)
    config.usage.use_custom_picon_dir = ConfigYesNo(default=False)
    config.usage.picon_dir = ConfigDirectory(default='/picon')
    ...
    config.usage.slider_graphic = ConfigYesNo(default=True)
    ...
    config.epgselection.graph_startmode = ConfigSelection(default='standard', choices=[('standard', _('Standard')),
     ('primetime', _('Primetime')),
     ('channel1', _('Channel 1')),
     ('channel1+primetime', _('Channel 1 with Primetime'))])
