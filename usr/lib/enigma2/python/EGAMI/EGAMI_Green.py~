...
class EGAMISpeedUpWizard(Screen, ConfigListScreen):
    ...
    def __init__(self, session, firstrun = False):
        ...
        self.pluglist.append(['ExtPlayer3 - ServiceApp', 'enigma2-plugin-systemplugins-serviceapp'])
        ...
        self.pluglist.append(['MediaStream - Italy', 'enigma2-plugin-extensions-mediastream'])
        ...
        self.pluglist.append(['Media Portal', 'enigma2-plugin-extensions-mediaportal'])
...
class EGAMISkinWizard(Screen, ConfigListScreen):
    ...
    def __init__(self, session, firstrun = False):
        ...
        self.pluglist = [['PinguTM Full HD', 'http://enigma-spark.com/egami/skins/PFHD.tar.gz'],
         ...
         ['YouViX Blue Full HD', 'enigma2-plugin-skins-openvix-blue-hd'],
         ['YouViX Green Full HD', 'enigma2-plugin-skins-openvix-green-hd'],
         ['YouViX Purple Full HD', 'enigma2-plugin-skins-openvix-purple-hd']]
        self.activityTimer = eTimer()
        self.activityTimer.timeout.get().append(self.updateFeed2)
        self.updateFeed()
