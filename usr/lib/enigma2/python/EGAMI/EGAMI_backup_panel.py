...
VERSION = 'Version: EGAMI %s' % about.getImageVersionString()
HaveGZkernel = True
if getMachineBuild() in ('vusolo4k', 'vuuno4k', 'vuultimo4k', 'spark', 'spark7162', 'hd51', 'hd52', 'sf4008', 'dm900'):
    HaveGZkernel = False
...
class EGFullBackup(Screen, ConfigListScreen):
    ...
    def doFullBackupCB(self):
        ...
        elif self.MODEL in ('vusolo4k', 'vuultimo4k', 'vuduo2', 'vusolo2', 'vusolo', 'vuduo', 'vuultimo', 'vuuno'):
            cmdlist.append('echo "This file forces a reboot after the update." > %s/reboot.update' % self.MAINDEST)
        elif self.MODEL in ('vuzero', 'vusolose', 'vuuno4k', 'xpeedlxpro', 'sf98'):
